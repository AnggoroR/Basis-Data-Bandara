...
$psw = query("SELECT * FROM pesawat WHERE kd_pesawat = $kd_pesawat")[0];
...
<header>
    ...
    <div class="container">
        <div class="d-flex justify-content-md-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h2 class="h2">Pengubahan Data Pesawat</h2>
        </div>

        <form action="" method="post" class="row g-3">
            <table class="table table-borderless">
                <tr>
                    <input type="hidden" name="kd_pesawat" id="kd_pesawat" value="<?= $psw["kd_pesawat"]; ?>">
                </tr>
                <tr>
                    <td>Kode Maskapai</td>
                    <td>
                        <input type="text" name="kd_maskapai" id="kd_maskapai" value="<?= $psw["kd_maskapai"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Id Penumpang</td>
                    <td>
                        <input type="text" name="id" value="<?= $psw["id"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Jumlah Seat</td>
                    <td>
                        <input type="text" name="jml_seat" id="jml_seat" value="<?= $psw["jml_seat"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Nomor Seat</td>
                    <td>
                        <input type="text" name="no_seat" id="no_seat" value="<?= $psw["no_seat"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Harga</td>
                    <td>
                        <input type="text" name="harga" id="harga" value="<?= $psw["harga"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td></td>
