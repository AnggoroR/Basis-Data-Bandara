        ...
        <table class="table table-borderless table table-striped table-light"">
            ...
            <?php foreach($penumpang as $row) : ?>
                <tr>
                    ...
                    <td><?= $row["umur"]; ?></td>
                    <td>
                        <a href="ubah (penumpang).php?id=<?= $row["id"]; ?>">
                            <button type="button" class="btn btn-success btn-sm">Ubah</button>
                        </a>
                        <a href="hapus (penumpang).php?id=<?= $row["id"]; ?>" onclick="return confirm('Apakah kamu yakin ingin menghapus data ini?');">
