...
$tkt = query("SELECT * FROM tiket WHERE no_tiket = $no_tiket")[0];
...
<header>
    ...
    <div class="container">
        <div class="d-flex justify-content-md-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h2 class="h2">Pengubahan Data Tiket</h2>
        </div>

        <form action="" method="post" class="row g-3">
            <table class="table table-borderless">
                <tr>
                    <input type="hidden" name="no_tiket" value="<?= $tkt["no_tiket"]; ?>">
                </tr>
                <tr>
                    <td>Kode Tujuan</td>
                    <td>
                        <input type="text" name="kd_tujuan" id="kd_tujuan" value="<?= $tkt["kd_tujuan"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Nama</td>
                    <td>
                        <input type="text" name="nama" id="nama" value="<?= $tkt["nama"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Nomor Seat</td>
                    <td>
                        <input type="text" name="no_seat" id="no_seat" value="<?= $tkt["no_seat"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Tujuan</td>
                    <td>
                        <input type="text" name="tujuan" id="tujuan" value="<?= $tkt["tujuan"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Waktu</td>
                    <td>
                        <input type="text" name="waktu" id="waktu" value="<?= $tkt["waktu"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td></td>
