...
<header>
    ...
    <div class="container">
        <div class="d-flex justify-content-md-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h2 class="h2">Penambahan Data Pesawat</h2>
        </div>
        ...
        <form action="" method="post" class="row g-3">
            <table class="table table-borderless"> 
                <tr>
                    <td>Kode Maskapai</td>
                    <td>   
                        <input type="text" name="kd_maskapai" id="kd_maskapai" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Id Penumpang</td>
                    <td>   
                        <input type="text" name="id" id="id" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Jumlah Seat</td>
                    <td>
                        <input type="text" name="jml_seat" id="jml_seat" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Nomor Seat</td>
                    <td>
                        <input type="textarea" name="no_seat" id="no_seat" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Harga</td>
                    <td>
                        <input type="textarea" name="harga" id="harga" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td></td>
