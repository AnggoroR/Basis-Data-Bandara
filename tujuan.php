...
$tujuan = query("SELECT * FROM tujuan");

// Jika tombol cari ditekan
if (isset($_POST["cari"])) {
    $tujuan = cari($_POST["keyword"]);
}
        ...
        <table class="table table-borderless table table-striped table-light">
            ...
            <?php foreach($tujuan as $row) : ?>
                <tr>
                    ...
                    <td>
                        <a href="ubah (tujuan).php?kd_tujuan=<?= $row["kd_tujuan"]; ?>">
                            <button type="button" class="btn btn-success btn-sm">Ubah</button>
                        </a>
                        <a href="hapus (tujuan).php?kd_tujuan=<?= $row["kd_tujuan"]; ?>" onclick="return confirm('Apakah kamu yakin ingin menghapus data ini?');">
