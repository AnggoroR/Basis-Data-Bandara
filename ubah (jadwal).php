...
$jdw = query("SELECT * FROM jadwal WHERE kd_maskapai = $kd_maskapai")[0];
...
<header>
    ...
    <div class="container">
        <div class="d-flex justify-content-md-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h2 class="h2">Pengubahan Data Jadwal</h2>
        </div>

        <form action="" method="post" class="row g-3">
            <table class="table table-borderless">
                <tr>
                    <input type="hidden" name="kd_maskapai" value="<?= $jdw["kd_maskapai"]; ?>">
                </tr>
                <tr>
                    <td>Kode Pesawat</td>
                    <td>
                        <input type="text" name="kd_pesawat" id="kd_pesawat" value="<?= $jdw["kd_pesawat"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Kode Tujuan</td>
                    <td>
                        <input type="text" name="kd_tujuan" id="kd_tujuan" value="<?= $jdw["kd_tujuan"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Tujuan</td>
                    <td>
                        <input type="text" name="tujuan" id="tujuan" value="<?= $jdw["tujuan"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                ...
                <tr>
                    <td>Waktu</td>
                    <td>
                        <input type="text" name="waktu" id="waktu" value="<?= $jdw["waktu"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td></td>
