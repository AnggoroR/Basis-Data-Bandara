...
<header>
    ...
    <div class="container">
        <div class="d-flex justify-content-md-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h2 class="h2">Penambahan Data Penumpang</h2>
        </div>
        ...
        <form action="" method="post" class="row g-3">
            <table class="table table-borderless"> 
                <tr>
                    <td>Nama</td>
                    <td>
                        <input type="text" name="nama" id="nama" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Jenis Kelamin</td>
                    <td>
                        <input type="text" name="jenis_kelamin" id="jenis_kelamin" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>
                        <input type="textarea" name="alamat" id="alamat" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>                 
                    <td>No. HP</td>
                    <td>
                        <input type="text" name="no_hp" id="no_hp" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Umur</td>
                    <td>
                        <input type="text" name="umur" id="umur" autocomplete="off" required class="form-control form-control-sm" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td></td>
