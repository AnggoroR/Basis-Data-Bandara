...
$pnp = query("SELECT * FROM penumpang WHERE id = $id")[0];
...
<header>
    ...
    <div class="container">
        <div class="d-flex justify-content-md-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h2 class="h2">Pengubahan Data Penumpang</h2>
        </div>

        <form action="" method="post" class="row g-3">
            <table class="table table-borderless">
                <tr>
                    <input type="hidden" name="id" value="<?= $pnp["id"]; ?>">
                </tr>
                <tr>
                    <td>Nama</td>
                    <td>
                        <input type="text" name="nama" id="nama" value="<?= $pnp["nama"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Jenis Kelamin</td>
                    <td>
                        <input type="text" name="jenis_kelamin" id="jenis_kelamin" value="<?= $pnp["jenis_kelamin"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>
                        <input type="text" name="alamat" id="alamat" value="<?= $pnp["alamat"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                ...
                <tr>
                    <td>No. HP</td>
                    <td>
                        <input type="text" name="no_hp" id="no_hp" value="<?= $pnp["no_hp"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td>Umur</td>
                    <td>
                        <input type="text" name="umur" id="umur" value="<?= $pnp["umur"]; ?>" autocomplete="off" required class="form-control" id="colFormLabelSm"/>
                    </td>
                </tr>
                <tr>
                    <td></td>
